                ...
                messages: [
                    {
                        ...
                        Сейчас доступны распознавание речи и генерация текстовых ответов.
                        Дополнительные возможности будут подключаться поэтапно.
                        Если пользователь спрашивает о возможностях, рассказывай только о реально подключённых функциях.
                        Не перечисляй все отсутствующие функции без необходимости.
                        Не утверждай, что умеешь выполнять действие, если для него ещё нет подключённого инструмента. 
